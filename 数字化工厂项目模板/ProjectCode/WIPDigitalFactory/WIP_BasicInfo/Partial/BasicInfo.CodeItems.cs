...
namespace WIP_BasicInfo
{
    public partial class BasicInfo
    {
        ...
        public ReturnBody<string> InsertCodeItems(CodeItemsEntity model)
        {
            ...
            ExceptionInfoEntity exception = WipLogHelper.GetNewExceptionInfoNoKey<CodeItemsEntity>(namespaceName, "InsertCodeItems", model);
            try
            {
                #region 验证
                if (model == null)
        ...
        {
            ReturnBody<string> retBody = null;
            ExceptionInfoEntity exception = WipLogHelper.GetNewExceptionInfoNoKey<CodeItemsEntity>(namespaceName, "UpdateCodeItems", model);
            try
            {
                #region 验证
        ...
        public ReturnBody<PageResultModel<CodeItemsEntity>> GetCodeItemsList(QueryCodeItemsModel queryModel)
        {
            ...
            var strWhere = "";
            ExceptionInfoEntity exception = WipLogHelper.GetNewExceptionInfoNoKey<QueryCodeItemsModel>(namespaceName, "GetCodeItemsList", queryModel);
            try
            {
                if (queryModel != null)
                {
        ...
        {
            ExceptionInfoEntity exception = WipLogHelper.GetNewExceptionInfoNoKey<QueryCodeItemsModel>(namespaceName, "GetSingleCodeItems", model);
            try
            {
                #region 验证
        ...
        {
            ExceptionInfoEntity exception = WipLogHelper.GetNewExceptionInfoNoKey<QueryCodeItemsModel>(namespaceName, "DelCodeItems", model);
            try
            {
                #region 验证
                if (model == null || model.id == 0)
        ...
        {
            ExceptionInfoEntity exception = WipLogHelper.GetNewExceptionInfoNoKey<GetAllCodeItemsByCodeSetParam>(namespaceName, "GetAllCodeItemsByCodeSet", param);
            try
            {
