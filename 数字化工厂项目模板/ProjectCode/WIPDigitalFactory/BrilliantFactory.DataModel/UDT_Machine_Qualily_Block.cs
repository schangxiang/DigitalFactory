...
{
    [Persistent(Table = "UDT_Machine_Qualily_Block")]
    public class UDT_Machine_Qualily_Block : ObjectType
    {
        [PrimaryKey(0)]
        ...
        public static Attribute<bool> CYLBOREAttribute = new Attribute<bool>();
        public static Attribute<bool> CRANKBOREAttribute = new Attribute<bool>();
        public static Attribute<bool> DECKHEIGHTAttribute = new Attribute<bool>();
        ...
        public bool CYLBORE
        {
            get { return GetAttributeValue(CYLBOREAttribute); }
            set { SetAttributeValue(CYLBOREAttribute, value); }
        }
        public bool CRANKBORE
        {
            get { return GetAttributeValue(CRANKBOREAttribute); }
            set { SetAttributeValue(CRANKBOREAttribute, value); }
        }
        public bool DECKHEIGHT
        {
            get { return GetAttributeValue(DECKHEIGHTAttribute); }
            set { SetAttributeValue(DECKHEIGHTAttribute, value); }
        }
