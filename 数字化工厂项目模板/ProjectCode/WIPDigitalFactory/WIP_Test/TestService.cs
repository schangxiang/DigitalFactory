...
namespace WIP_Test
{
    ...
    public class TestService : ITestService
    {
        ...
        {
            ExceptionInfoEntity exception = WipLogHelper.GetNewExceptionInfoNoKey<GetEncryptData>(namespaceName, "GetEncryptData", param);
            try
            {
                string result = "";
        ...
        {
            ExceptionInfoEntity exception = WipLogHelper.GetNewExceptionInfoNoKey<GenerateTokenParam>(namespaceName, "GenerateToken", user);
            try
            {
        ...
        {
            ExceptionInfoEntity exception = WipLogHelper.GetNewExceptionInfoNoKey<MailParam>(namespaceName, "SendMail", param);
            try
            {
